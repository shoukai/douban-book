...
public class BookDataRequest {
    ...
    static String DOUBAN_REQUEST_URL_TEMPLATE = "https://api.douban.com/v2/book/user/%s/collections?status=read&start=%d&count=%d&apikey=054022eaeae0b00e0fc068c0c0a2102a";
